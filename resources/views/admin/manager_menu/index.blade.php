    ...
    <table class="table table-sm table-hover table-bb">
        ...
        @foreach($list as $vo)
            <tr>
                ...
                <td>
                    <a class="btn btn-sm btn-light" href="{{url('/admin/manager_menu/edit?id='.$vo['id'])}}" role="button" title="编辑"><i class="fa fa-edit"></i></a>
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="#" onclick="return alert_win('{{$vo['name']}}',{{$vo['id']}},{{$vo['depth']}})"><i class="fa fa-arrows
"></i> 加子菜单</a>
