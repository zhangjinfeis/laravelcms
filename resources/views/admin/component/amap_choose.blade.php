...
zoom:缩放级别默认值,选填
--}}
<div id="{{$input_lng}}map" style="width:{{$width ?? '100%'}};height:{{$height ?? '400px'}};overflow: hidden;margin:0;font-family:'微软雅黑';"></div>
...
@if(isset($input_zoom))
    <input type="hidden" name="{{$input_zoom}}" value="{{$zoom ?? '15'}}">
@endif
